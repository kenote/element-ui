...
KlChannelSearchbar = __decorateClass$b([
  Component({
...
KlSidebarItem = __decorateClass$9([
  Component({
    name: "KlSidebarItem"
  })
], KlSidebarItem);
...
__decorateClass$5([
  Provide()
], KlFormItem$1.prototype, "propKey", 2);
__decorateClass$5([
  Model("update")
...
KlFormItem$1 = __decorateClass$5([
  Component({
    name: "KlFormItem",
    created() {
      var _a, _b, _c;
...
KlFormExpand$1 = __decorateClass$3([
  Component({
    name: "KlFormExpand"
  })
], KlFormExpand$1);
...
var render$2 = function() {
  var _vm$options, _vm$options2, _vm$options3, _vm$options4;
  var _vm = this;
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("div", {
