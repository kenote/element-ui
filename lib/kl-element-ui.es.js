import Vue from "vue";
import _, { merge, compact, trim, assign, pickBy, unset, isString, isFunction, get, map, isPlainObject, isBoolean, isDate, cloneDeep, isArray, omit, isNaN, template } from "lodash";
...
__decorateClass([
  Provide()
], KlFormItem.prototype, "propKey", 2);
__decorateClass([
  Model("update")
