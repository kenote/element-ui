import Vue from "vue";
import _, { merge, compact, trim, assign, pickBy, unset, isString, isFunction, map, pick, isEqual, omitBy, isUndefined, cloneDeep, set, omit, zipObject, get, orderBy, chunk, isBoolean, isArray, isPlainObject, isDate, isNaN as isNaN$1, template } from "lodash";
...
KlChannelSearchbar = __decorateClass$g([
  Component({
...
KlSidebarItem = __decorateClass$e([
  Component({
    name: "KlSidebarItem"
  })
], KlSidebarItem);
...
KlFormItem$1 = __decorateClass$a([
  Component({
    name: "KlFormItem",
    created() {
      var _a, _b, _c;
...
KlFormExpand$1 = __decorateClass$8([
  Component({
    name: "KlFormExpand"
  })
], KlFormExpand$1);
...
KlPlanPicker$1 = __decorateClass$7([
  Component({
    name: "KlPlanPicker",
    components: {
      KlFormItem
...
KlDiakogForm = __decorateClass$4([
  Component({
    name: "KlDiakogForm",
    components: {
      KlDialog,
...
KlTableColumnCell = __decorateClass$3([
  Component({
...
let KlCodeEditor = class extends mixins(KlBaseMixin, _default) {
  constructor() {
    super(...arguments);
    this.code = "";
  }
  ...
  onValueChange(val, oldVal) {
    ...
    if (val === oldVal)
      return;
    this.code = val;
    (_a = this.editor) == null ? void 0 : _a.setValue(val);
  }
  ...
  onThemeChange(val, oldVal) {
    if (val === oldVal)
      return;
    monaco.editor.setTheme(val);
  }
  onLanguageChange(val, oldVal) {
    var _a;
    if (val === oldVal)
      return;
    monaco.editor.setModelLanguage((_a = this.editor) == null ? void 0 : _a.getModel(), val);
  }
  onTabSizeChange(val, oldVal) {
    var _a, _b;
    if (val === oldVal)
      return;
    (_b = (_a = this.editor) == null ? void 0 : _a.getModel()) == null ? void 0 : _b.updateOptions({ tabSize: val });
  }
  onMinimapChange(val, oldVal) {
    var _a;
    if (val === oldVal)
      return;
    (_a = this.editor) == null ? void 0 : _a.updateOptions({ minimap: getMinimap(val) });
  }
  initialEditor() {
    var _a;
    let codeEditor2 = (_a = this.$refs) == null ? void 0 : _a["codeEditor"];
    this.editor = monaco.editor.create(codeEditor2, {
      value: this.code,
    ...
    this.editor.onDidChangeModelContent((evt) => {
      var _a2;
      let value = (_a2 = this.editor) == null ? void 0 : _a2.getValue();
      this.change(value != null ? value : "");
      this == null ? void 0 : this.dispatch("ElFormItem", "el.form.change", value);
    });
  }
};
__decorateClass$1([
  Prop({ default: "javascript" })
], KlCodeEditor.prototype, "language", 2);
__decorateClass$1([
  Prop({ default: "vs" })
], KlCodeEditor.prototype, "theme", 2);
__decorateClass$1([
  Prop({ default: false })
], KlCodeEditor.prototype, "border", 2);
__decorateClass$1([
  Prop({ default: 4 })
], KlCodeEditor.prototype, "tabSize", 2);
__decorateClass$1([
  Prop({ default: false })
], KlCodeEditor.prototype, "minimap", 2);
__decorateClass$1([
  Prop()
], KlCodeEditor.prototype, "width", 2);
__decorateClass$1([
  Prop({ default: 500 })
], KlCodeEditor.prototype, "height", 2);
__decorateClass$1([
  Prop({ default: false })
], KlCodeEditor.prototype, "readOnly", 2);
__decorateClass$1([
  Provide()
], KlCodeEditor.prototype, "code", 2);
__decorateClass$1([
  Provide()
], KlCodeEditor.prototype, "editor", 2);
__decorateClass$1([
  Model("update")
], KlCodeEditor.prototype, "value", 2);
__decorateClass$1([
  Emit("update")
], KlCodeEditor.prototype, "update", 1);
__decorateClass$1([
  Emit("change")
], KlCodeEditor.prototype, "change", 1);
__decorateClass$1([
  Watch("value")
], KlCodeEditor.prototype, "onValueChange", 1);
__decorateClass$1([
  Watch("code")
], KlCodeEditor.prototype, "onCodeChange", 1);
__decorateClass$1([
  Watch("theme")
], KlCodeEditor.prototype, "onThemeChange", 1);
__decorateClass$1([
  Watch("language")
], KlCodeEditor.prototype, "onLanguageChange", 1);
__decorateClass$1([
  Watch("tabSize")
], KlCodeEditor.prototype, "onTabSizeChange", 1);
__decorateClass$1([
  Watch("minimap")
], KlCodeEditor.prototype, "onMinimapChange", 1);
KlCodeEditor = __decorateClass$1([
  Component({
    name: "KlCodeEditor",
    mounted() {
      var _a;
...
var render$1 = function() {
  ...
  return _c("div", {
    ref: "codeEditor",
    class: _vm.border ? "code-editer__broder" : "",
    style: {
      width: _vm.toStyleSize(_vm.width),
      height: _vm.toStyleSize(_vm.height)
    }
  });
};
...
let KlDiffEditor = class extends mixins(KlBaseMixin, _default) {
  change(value) {
  }
  onThemeChange(val, oldVal) {
    if (val === oldVal)
  ...
  initialEditor() {
    var _a;
    let diffEditor2 = (_a = this.$refs) == null ? void 0 : _a["diffEditor"];
    this.editor = monaco.editor.createDiffEditor(diffEditor2, {
      fontSize: 14,
      automaticLayout: true
    });
    ...
    this.editor.onDidUpdateDiff((evt) => {
      var _a2;
      let value = (_a2 = this.editor) == null ? void 0 : _a2.getModifiedEditor().getValue();
      this.change(value != null ? value : "");
      this == null ? void 0 : this.dispatch("ElFormItem", "el.form.change", value);
    });
  }
...
__decorateClass([
  Prop({ default: false })
], KlDiffEditor.prototype, "border", 2);
__decorateClass([
  Prop()
], KlDiffEditor.prototype, "width", 2);
__decorateClass([
  Prop({ default: 500 })
], KlDiffEditor.prototype, "height", 2);
__decorateClass([
  Prop({ default: "" })
], KlDiffEditor.prototype, "original", 2);
__decorateClass([
  Prop({ default: "" })
], KlDiffEditor.prototype, "modified", 2);
__decorateClass([
  Prop({ default: "javascript" })
], KlDiffEditor.prototype, "language", 2);
__decorateClass([
  Prop({ default: "vs" })
], KlDiffEditor.prototype, "theme", 2);
__decorateClass([
  Provide()
], KlDiffEditor.prototype, "editor", 2);
__decorateClass([
  Emit("change")
], KlDiffEditor.prototype, "change", 1);
__decorateClass([
  Watch("theme")
], KlDiffEditor.prototype, "onThemeChange", 1);
KlDiffEditor = __decorateClass([
  Component({
    name: "KlDiffEditor",
    mounted() {
      this.initialEditor();
...
var staticRenderFns = [];
var diffEditor_vue_vue_type_style_index_0_lang = "";
const __cssModules = {};
...
var diffEditor = /* @__PURE__ */ function() {
