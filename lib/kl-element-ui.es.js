import Vue from "vue";
import _, { merge, compact, trim, assign, pickBy, isString, isFunction, get, map, isPlainObject, isBoolean, isDate, omit, isNaN, template } from "lodash";
...
__decorateClass([
  Prop({ default: void 0 })
], KlFormItem.prototype, "pickerOptions", 2);
__decorateClass([
  Prop({ default: void 0 })
], KlFormItem.prototype, "requestOptions", 2);
__decorateClass([
  Provide()
...
__decorateClass([
  Provide()
], KlFormItem.prototype, "filterMethod", 2);
__decorateClass([
  Provide()
], KlFormItem.prototype, "filter", 2);
__decorateClass([
  Model("update")
...
__decorateClass([
  Emit("get-data")
], KlFormItem.prototype, "getData", 1);
__decorateClass([
  Watch("value")
...
var render = function() {
  ...
  return _vm.type == "password" ? _c("el-input", {
    ...
    attrs: {
      "placeholder": _vm.placeholder,
      "disabled": _vm.disabled,
      "clearable": (_vm$options47 = _vm.options) === null || _vm$options47 === void 0 ? void 0 : _vm$options47.clearable,
      "minlength": (_vm$options48 = _vm.options) === null || _vm$options48 === void 0 ? void 0 : _vm$options48.minlength,
      "maxlength": (_vm$options49 = _vm.options) === null || _vm$options49 === void 0 ? void 0 : _vm$options49.maxlength,
      "show-word-limit": (_vm$options50 = _vm.options) === null || _vm$options50 === void 0 ? void 0 : _vm$options50.showWordLimit,
      "prefix-icon": (_vm$options51 = _vm.options) === null || _vm$options51 === void 0 ? void 0 : _vm$options51.prefixIcon,
      "suffix-icon": (_vm$options52 = _vm.options) === null || _vm$options52 === void 0 ? void 0 : _vm$options52.suffixIcon,
      "size": _vm.size,
      "readonly": _vm.readonly
    },
    model: {
